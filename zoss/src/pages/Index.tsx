...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-zoss-cream">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-4xl space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-start items-start pt-4">
              ...
              <Link to="/b2c-solutions">
                <Button size="lg" variant="outline" className="group border-3 border-white/80 text-white hover:bg-white hover:text-zoss-blue px-12 py-6 text-lg font-semibold tracking-wider rounded-full shadow-2xl backdrop-blur-sm bg-white/10 transform hover:scale-105 transition-all duration-300">
                  <Droplets className="mr-3 h-6 w-6 group-hover:bounce transition-transform" />
                  SEE HOME PLANS
                  <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform" />
                </Button>
              </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="w-full h-[500px] bg-gradient-to-br from-blue-50 via-white to-green-50 rounded-3xl flex items-center justify-center shadow-2xl border border-gray-100 overflow-hidden">
                <img 
                  src="/lovable-uploads/fa2ec602-f0a0-40af-84ef-38fd116ef557.png"
      ...
      {/* Know Your Dosha Section - Replaced with new component */}
      <DoshaQuestionnaire />

      {/* B2B Calculator Section - Exact replica from image */}
            ...
            {[
              ...
              <Card key={index} className={`relative hover:shadow-2xl transition-all duration-300 border-2 ${plan.popular ? 'border-zoss-green scale-105' : 'border-gray-200 hover:border-zoss-green/50'} bg-white/80 backdrop-blur-sm`}>
                ...
                <CardContent className="pt-0">
                  ...
                  <Link to="/subscription-model">
                    <Button className={`w-full ${plan.popular ? 'bg-gradient-to-r from-zoss-green to-green-600 hover:from-zoss-green/90 hover:to-green-600/90' : 'bg-zoss-green hover:bg-zoss-green/90'} text-white py-3 font-semibold`}>
                      Choose Plan
                    </Button>
                  </Link>
                </CardContent>
              ...
              <Card key={index} className="hover:shadow-2xl transition-all duration-300 border-0 bg-white overflow-hidden group">
                ...
                <CardContent className="p-8">
                  <div className="flex items-center space-x-2 mb-3">
                    <Badge variant="outline" className="text-zoss-green border-zoss-green text-xs">
                      {article.readTime}
                    </Badge>
                  </div>
